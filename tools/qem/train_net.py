...
from qem.datasets.dataset import build_dataset, make_data_sampler, make_test_data_loader, make_train_data_loader
from qem.datasets.evaluation import Evaluation
from qem.modeling.model_builder import Generalized_CNN
...
if __name__ == '__main__':
    # Parse arguments
    parser = argparse.ArgumentParser(description='qem Model Training')
    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file',
                        default='./cfgs/CIHP/QEM/QEM_R-50c_512x384_1x.yaml', type=str)
    parser.add_argument('--local_rank', type=int, default=0)
    parser.add_argument('opts', help='See qem/core/config.py for all options',
                        default=None,
