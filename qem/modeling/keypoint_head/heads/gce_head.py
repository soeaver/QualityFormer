...
class GCEHead(nn.Module):
    def __init__(self, cfg, dim_in, spatial_in):
        ...
        conv_dim = cfg.KEYPOINT.GCE_HEAD.CONV_DIM
        aspp_dim = cfg.KEYPOINT.GCE_HEAD.ASPP_DIM
        num_convs_before_aspp = cfg.KEYPOINT.GCE_HEAD.NUM_CONVS_BEFORE_ASPP
        aspp_dilation = cfg.KEYPOINT.GCE_HEAD.ASPP_DILATION
        num_convs_after_aspp = cfg.KEYPOINT.GCE_HEAD.NUM_CONVS_AFTER_ASPP
