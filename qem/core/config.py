...
# The head of QEM to use
# (e.g., "qem_head")
_C.PARSING.QEM.QEM_HEAD = "qem_head"

# Output module of Quality head
_C.PARSING.QEM.QEM_OUTPUT = "qem_output"

# Number of stacked QEM
_C.PARSING.QEM.STACK_NUM = 2

# Number of share Conv layers in the QEM head
_C.PARSING.QEM.NUM_SHARE_CONVS = 1

# Number of parsing Conv layers in the QEM head
_C.PARSING.QEM.NUM_PARSING_CONVS = 1

# Number of mask Conv layers in the QEM head
_C.PARSING.QEM.NUM_IOU_CONVS = 2

# Hidden Conv layer dimension of QEM head
_C.PARSING.QEM.PARSING_CONV_DIM = 128

# Hidden MLP layer dimension of QEM head
_C.PARSING.QEM.IOU_CONV_DIM = 512

# Number of output Conv layers in the QEM head
_C.PARSING.QEM.NUM_OUT_CONVS = 2

# Type of normalization in the QEM head
# E.g., 'FrozenBN', 'BN', 'SyncBN', 'GN', 'MixBN', 'MixGN', ...
_C.PARSING.QEM.NORM = ""

# Middle conv dim in QEM
_C.PARSING.QEM.QEM_DIM = 256

# Whether or not use input dim as QEM output feature dim
_C.PARSING.QEM.KEEP_DIM = False

# If KEEP_DIM = False use OUTPUT_DIM as QEM output feature dim, else use input dim as output feature dim
_C.PARSING.QEM.OUTPUT_DIM = 256

# Drop out rate of QEM
_C.PARSING.QEM.DROP_RATE = 0.0

# Parsing loss weight for QEM head
_C.PARSING.QEM.PARSING_LOSS_WEIGHT = 0.5

# Lovasz loss for QEM head
_C.PARSING.QEM.LOVASZ_LOSS_WEIGHT = 0.0

# IoU loss weight for QEM head
_C.PARSING.QEM.IOU_LOSS_WEIGHT = 0.5
